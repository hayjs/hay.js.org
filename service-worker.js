...
var CacheNamePrefix = 'sw-hay-' + (self.registration ? self.registration.scope : '') + '-';
...
function getCacheBustedUrl(url, param) {
...
function populateCurrentCacheNames(precacheConfig, cacheNamePrefix, baseUrl) {
